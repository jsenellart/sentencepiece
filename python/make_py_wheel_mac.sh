...
build() {
  ...
  build_python 2.7 https://www.python.org/ftp/python/2.7.15/python-2.7.15-macosx10.9.pkg
  ...
  build_python 3.6 https://www.python.org/ftp/python/3.6.6/python-3.6.6-macosx10.9.pkg
  build_python 3.7 https://www.python.org/ftp/python/3.7.0/python-3.7.0-macosx10.9.pkg
